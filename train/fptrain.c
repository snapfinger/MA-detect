...
#define MAX_LMR 100 //in this file, this stands for number of training data
...
#define I 18//for test


VXparam_t par[] =             // command line structure            
{ //prefix, value,   description                          
{    "if=",    0,   " input training label file"},
{    "y=",     0,   0},  
{    "x=",     0,   0},
};
...
fp_out=fopen("forTrainFalseP.csv","w");
if(!fp_out){
...
//fprintf(fp_out,"%s,%d,%d,%f,%f,%f,%f,%f,%f,%f\n",IVAL,y_in,x_in,mpwidths,sdpwidths,mtwidths,sdtwidths,sdrslopes,cvrheights,cvpheights);
fprintf(fp_out,"%s,%d,%d,%f,%f,%f,%f,%f,%f,%f\n",IVAL,y_in,x_in,
mpwidths,sdpwidths,mtwidths,sdtwidths,sdrslopes,cvrheights,cvpheights);
